  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 pb-0">
        <div className="grid items-start gap-5 md:gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div className="reveal relative z-10 pb-4 md:pb-12">
            ...
            <h1 className="max-w-[10.5ch] font-display text-[clamp(34px,9vw,68px)] font-extrabold leading-[0.98] tracking-[-0.05em] text-balance">
